...
class SiglipVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            if SiglipVisionConfig is None:
                raise ImportError("SiglipVisionConfig not available. Please upgrade transformers.") from _siglip_import_error
    ...
    def load_model(self, device_map=None):
        ...
        if SiglipVisionModel is None or SiglipImageProcessor is None:
    ...
    def feature_select(self, image_forward_outs):
        ...
        if self.select_feature in ("patch", "cls_patch"):
            # SigLIP has no CLS token; keep all patch tokens.
