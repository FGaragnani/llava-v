#!/bin/bash
#SBATCH --job-name=llava-base_s3--align_mean-midL_siglip
...
srun --exclusive -c $SLURM_CPUS_PER_TASK --mem $SLURM_MEM_PER_NODE \
	...
	--patch_model_name /leonardo_scratch/large/userexternal/fgaragna/models/lmsys/openai/clip-vit-large-patch14-336 \
