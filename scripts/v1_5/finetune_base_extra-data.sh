#!/bin/bash
#SBATCH --job-name=llava-base_s2-extra_data
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-base/pretrain/llava-base_s1--base_extra/mm_projector.bin"
