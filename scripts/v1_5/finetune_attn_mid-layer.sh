#!/bin/bash
#SBATCH --job-name=llava-v_s2--attn-midL
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--attn-midL/mm_projector.bin"
