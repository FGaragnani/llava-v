#!/bin/bash
#SBATCH --job-name=llava--only-GLAMM-s2
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-only-GLAMM/mm_projector.bin"
