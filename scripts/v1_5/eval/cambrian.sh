...
llava_more="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/llava-v_s2--attn/" # <--
model_name="${1:-${llava_more}}"
conv_mode="${2:-vicuna_v1}"
eval_output_dir="/leonardo_scratch/large/userexternal/fgaragna/logs/cambrian-eval-llava--attn" # <--
gpu_devices="${3:-0}"
