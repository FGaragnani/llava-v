...
llava_more="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-base/llava-base_s2-extra_data/" # <--
model_name="${1:-${llava_more}}"
conv_mode="${2:-vicuna_v1}"
eval_output_dir="/leonardo_scratch/large/userexternal/fgaragna/logs/cambrian-eval-llava--base-extra-data" # <--
gpu_devices="${3:-0}"
