#!/bin/bash
#SBATCH --job-name=llava-v_s2--mean-midL-siglip
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-midL-siglip/mm_projector.bin"
