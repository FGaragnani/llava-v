#!/bin/bash
#SBATCH --job-name=llava-v_s2--mean-midL_ve-siglip
...
clip_model_name_or_path="/leonardo_scratch/large/userexternal/fgaragna/models/lmsys/google/siglip-large-patch16-256"
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-midL_ve-siglip/mm_projector.bin"
