#!/bin/bash
#SBATCH --job-name=llava-v_s1--mean-midL_ve-siglip
...
clip_model_name_or_path="/leonardo_scratch/large/userexternal/fgaragna/models/lmsys/models--google--siglip-large-patch16-256"
