#!/bin/bash
#SBATCH --job-name=llava-v_s2--ve-qwen2_5
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--ve-qwen2_5/mm_projector.bin"
