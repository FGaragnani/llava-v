#!/bin/bash
#SBATCH --job-name=llava-v_s2--mean-midL_ve-qwen2_5
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-midL_ve-qwen2_5/mm_projector.bin"
...
srun --exclusive -c $SLURM_CPUS_PER_TASK --mem $SLURM_MEM_PER_NODE \
    ...
    --model_name_or_path "/leonardo_scratch/large/userexternal/fgaragna/models/lmsys/Qwen/Qwen2.5-7B-Instruct" \
    --save_steps 12000 \
    --save_total_limit 1 \
