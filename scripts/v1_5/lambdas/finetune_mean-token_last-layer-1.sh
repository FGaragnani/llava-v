#!/bin/bash
#SBATCH --job-name=llava-v_s2--mean-1
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-1/mm_projector.bin"
