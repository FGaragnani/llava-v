#!/bin/bash
#SBATCH --job-name=llava--only-GLAMM-align--mean-1
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-only-GLAMM-align-s1--mean-1/mm_projector.bin"
