#!/bin/bash
#SBATCH --job-name=llava--only-GLAMM-align--last-midL
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-only-GLAMM-align-s1--last-midL/mm_projector.bin"
