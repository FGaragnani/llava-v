#!/bin/bash
#SBATCH --job-name=llava--mean-midL-full
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-midL-full/mm_projector.bin"
