#!/bin/bash
#SBATCH --job-name=llava--only-GLAMM--mean-midL-full
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1_only-GLAMM--mean-midL-full/mm_projector.bin"
