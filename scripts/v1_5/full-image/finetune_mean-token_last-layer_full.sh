#!/bin/bash
#SBATCH --job-name=llava--mean-full
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-full/mm_projector.bin"
