#!/bin/bash
#SBATCH --job-name=llava-v_s2--last-midL
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--last_mid/mm_projector.bin"
