#!/bin/bash
#SBATCH --job-name=llava-v_s2--mean-midL-full-iti
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean-midL-full-iti/mm_projector.bin"
