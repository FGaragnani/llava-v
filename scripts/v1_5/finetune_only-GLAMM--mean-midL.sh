#!/bin/bash
#SBATCH --job-name=llava--only-GLAMM-align--mean-midL
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-only-GLAMM-align-s1--mean-midL/mm_projector.bin"
