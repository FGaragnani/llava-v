#!/bin/bash
#SBATCH --job-name=llava-v_s2--mean_24L
...
model_name="/leonardo_scratch/large/userexternal/fgaragna/checkpoints/llava-v/pretrain/llava-v_s1--mean_24L/mm_projector.bin"
